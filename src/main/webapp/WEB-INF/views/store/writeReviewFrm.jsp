<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<body>
			...
			<hr>
			<br>
			<form class="mb-3" id="reviewForm" method="post" enctype="multipart/form-data">
				<div>
				...
				<div>
					...
					<%-- <input type="hidden" name="storeNo" value="${s.storeNo }"> --%>
						<input type="file" name="reviewImgName" class="file-upload" id="file"
				...
				<div class="btnWrap">
					...
					<button type="submit" value="등록" onclick="writeReview()">등록</button>
				</div>
			</form>
			<script>
				(function ($) {
