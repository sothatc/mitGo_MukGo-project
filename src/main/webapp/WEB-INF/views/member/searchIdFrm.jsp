		...
		<div class="searchContent">
			<fieldset>
				<legend>아이디 찾기</legend>
		            ...
		            <form action="/searchNormalId.do" method="post">
						이 름 : <input type="text" id="memberName" name="memberName">
						<br><br>
		            ...
		            <form action="/searchOwnerId.do" method="post">
		            	이 름 : <input type="text" id="ownerName" name="ownerName">
		            	<br><br>
