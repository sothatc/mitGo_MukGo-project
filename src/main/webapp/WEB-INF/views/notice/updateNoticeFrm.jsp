   ...
   <jsp:include page="/WEB-INF/views/common/header.jsp"></jsp:include>
    ...
    <div class="notice-write-wrap">
        ...
        <div class="notice-write-frm">
            <form action="/updateNotice.do" id="noticeFrm" method="post" enctype="multipart/form-data">
                ...
                <table class="notice-tbl">
                   ...
                   <!--  <tr style="height: 70px; border-bottom: 1px solid rgba(224, 224, 224, 0.7);">
                    ...
                    <c:choose>
                    	<c:when test="${not empty n.fileList }">
		                       ...
		                       <td style="width: 700px;">
		                          <div class="fileList">
		                             <c:forEach items="${n.fileList }" var="nf">
		                             	<div class="listFile">
		                             		<span>${nf.filename }</span><span class="deleteBtn2" onclick="deleteFile2(this, ${nf.noticeFileNo}, '/resources/upload/notice/${nf.filepath }');">x</span>
		                             	</div>
		                             </c:forEach>
		                          </div>
		                       </td>
